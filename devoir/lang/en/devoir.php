...
$string['pluginname'] = 'Collaboratif assignment';
$string['modulename'] = 'Collaboratif Assignement';
...
$string['activityoverview'] = 'You have Collaboratif assignments that need attention';
...
$string['allowsubmissions'] = 'Allow the user to continue making submissions to this Collaboratif assignment.';
...
$string['alwaysshowdescription_help'] = 'If disabled, the Collaboratif assignment description above will only become visible to students on the "Allow submissions from" date.';
$string['applytoteam'] = 'Apply grades and feedback to entire group';
$string['Collaboratif assignment:addinstance'] = 'Add a new Collaboratif assignment';
$string['Collaboratif assignment:exportownsubmission'] = 'Export own submission';
$string['Collaboratif assignment:editothersubmission'] = 'Edit another student\'s submission';
$string['Collaboratif assignment:grade'] = 'Grade Collaboratif assignment';
$string['Collaboratif assignment:grantextension'] = 'Grant extension';
$string['Collaboratif assignment:manageallocations'] = 'Manage markers allocated to submissions';
$string['Collaboratif assignment:managegrades'] = 'Review and release grades';
$string['Collaboratif assignment:manageoverrides'] = 'Manage Collaboratif assignment overrides';
$string['Collaboratif assignment:receivegradernotifications'] = 'Receive grader submission notifications';
$string['Collaboratif assignment:releasegrades'] = 'Release grades';
$string['Collaboratif assignment:revealidentities'] = 'Reveal student identities';
$string['Collaboratif assignment:reviewgrades'] = 'Review grades';
$string['Collaboratif assignment:viewblinddetails'] = 'View student identities when anonymous submissions are enabled';
$string['Collaboratif assignment:viewgrades'] = 'View grades';
$string['Collaboratif assignment:showhiddengrader'] = 'See the identity of a hidden grader';
$string['Collaboratif assignment:submit'] = 'Submit Collaboratif assignment';
$string['Collaboratif assignment:view'] = 'View Collaboratif assignment';
$string['Collaboratif assignment:viewownsubmissionsummary'] = 'View own submission summary';
$string['Collaboratif assignmentfeedback'] = 'Feedback plugin';
$string['Collaboratif assignmentfeedbackpluginname'] = 'Feedback plugin';
$string['Collaboratif assignmentisdue'] = 'Collaboratif assignment is due';
$string['Collaboratif assignmentmail'] = '{$a->grader} has posted some feedback on your
Collaboratif assignment submission for \'{$a->Collaboratif assignment}\'

You can see it appended to your Collaboratif assignment submission:

    {$a->url}';
$string['Collaboratif assignmentmailhtml'] = '<p>{$a->grader} has posted some feedback on your
Collaboratif assignment submission for \'<i>{$a->Collaboratif assignment}</i>\'.</p>
<p>You can see it appended to your <a href="{$a->url}">Collaboratif assignment submission</a>.</p>';
$string['Collaboratif assignmentmailsmall'] = '{$a->grader} has posted some feedback on your
Collaboratif assignment submission for \'{$a->Collaboratif assignment}\' You can see it appended to your submission';
$string['Collaboratif assignmentname'] = 'Collaboratif assignment name';
$string['Collaboratif assignmentplugins'] = 'Collaboratif assignment plugins';
$string['Collaboratif assignmentsperpage'] = 'Collaboratif assignments per page';
$string['Collaboratif assignmentsubmission'] = 'Submission plugin';
$string['Collaboratif assignmentsubmissionpluginname'] = 'Submission plugin';
$string['file'] = 'My work';
$string['file_help'] = 'Drag your work in this area in order to submitt it to your responsible. (If your document type isnt allowed your work wont be sent ! )
';
$string['Description'] = 'Description';
$string['Description_help'] = 'Short information that students must know about their collaboratif assignment';
...
$string['attemptreopenmethod_help'] = 'This setting determines whether a student can make additional attempts at the Collaboratif assignment. For each attempt, the grade and feedback are saved, and can be viewed by the teacher and the student. The available options are:

* Never - Only one attempt is possible.
* Manually - Additional attempts may be allowed by a teacher.
* Automatically until pass - Additional attempts are allowed automatically until the student achieves the grade to pass set in the gradebook for this Collaboratif assignment.';
...
$string['backtoCollaboratif assignment'] = 'Back to Collaboratif assignment';
...
$string['blindmarking_help'] = 'Anonymous submissions hide the identity of students from markers. Anonymous submission settings will be locked once a submission or grade has been made in relation to this Collaboratif assignment.';
...
$string['conversionexception'] = 'Could not convert Collaboratif assignment. Exception was: {$a}.';
...
$string['couldnotconvertgrade'] = 'Could not convert Collaboratif assignment grade for user {$a}.';
$string['couldnotconvertsubmission'] = 'Could not convert Collaboratif assignment submission for user {$a}.';
$string['couldnotcreatecoursemodule'] = 'Could not create course module.';
$string['couldnotcreatenewCollaboratif assignmentinstance'] = 'Could not create new Collaboratif assignment instance.';
$string['couldnotfindCollaboratif assignmenttoupgrade'] = 'Could not find old Collaboratif assignment instance to upgrade.';
$string['crontask'] = 'Background processing for Collaboratif assignment module';
$string['currentCollaboratif assignmentgrade'] = 'Current grade in Collaboratif assignment';
...
$string['cutoffdate_help'] = 'If set, the Collaboratif assignment will not accept submissions after this date without an extension.';
...
$string['defaultsettings'] = 'Default Collaboratif assignment settings';
$string['defaultsettings_help'] = 'These settings define the defaults for all new Collaboratif assignments.';
...
$string['downloadasfolders_help'] = 'Collaboratif assignment submissions may be downloaded in folders. Each submission is then put in a separate folder, with the folder structure kept for any subfolders, and files are not renamed.';
$string['downloadselectedsubmissions'] = 'Download selected submissions';
$string['duedate'] = 'Due date';
$string['duedatecolon'] = 'Due date: {$a}';
$string['duedate_help'] = 'This is when the Collaboratif assignment is due. Submissions will still be allowed after this date, but any Collaboratif assignments submitted after this date will be marked as late. Set an Collaboratif assignment cut-off date to prevent submissions after a certain date.';
...
$string['duedatereached'] = 'The due date for this Collaboratif assignment has now passed';
...
$string['eventoverridecreated'] = 'Collaboratif assignment override created';
$string['eventoverridedeleted'] = 'Collaboratif assignment override deleted';
$string['eventoverrideupdated'] = 'Collaboratif assignment override updated';
...
$string['fixrescalednullgrades'] = 'This Collaboratif assignment contains some erroneous grades. You can <a href="{$a->link}">automatically fix these grades</a>. This may affect course totals.';
...
$string['gradersubmissionupdatedtext'] = '{$a->username} has updated their Collaboratif assignment submission
for \'{$a->Collaboratif assignment}\' at {$a->timeupdated}

It is available here:

    {$a->url}';
$string['gradersubmissionupdatedhtml'] = '{$a->username} has updated their Collaboratif assignment submission
for <i>\'{$a->Collaboratif assignment}\'  at {$a->timeupdated}</i><br /><br />
It is <a href="{$a->url}">available on the web site</a>.';
$string['gradersubmissionupdatedsmall'] = '{$a->username} has updated their submission for Collaboratif assignment {$a->Collaboratif assignment}.';
...
$string['errorquickgradingvsadvancedgrading'] = 'The grades were not saved because this Collaboratif assignment is currently using advanced grading';
...
Collaboratif assignment submission for \'<i>{$a->Collaboratif assignment}</i>\'<br /><br />
You can see it appended to your <a href="{$a->url}">Collaboratif assignment submission</a>.';
$string['feedbackavailablesmall'] = '{$a->username} has given feedback for Collaboratif assignment {$a->Collaboratif assignment}';
...
Collaboratif assignment submission for \'<i>{$a->Collaboratif assignment}</i>\'<br /><br />
You can see it appended to your <a href="{$a->url}">Collaboratif assignment submission</a>.';
$string['feedbackavailableanonsmall'] = 'New feedback for Collaboratif assignment {$a->Collaboratif assignment}';
...
$string['feedbackpluginforgradebook_help'] = 'Only one Collaboratif assignment feedback plugin can push feedback into the gradebook.';
...
$string['file_type'] = 'Allowed file types';
$string['file_type_help'] = 'Precise which type of files will be allowed';
...
$string['hidegrader_help'] = 'If enabled, the identity of any user who grades an Collaboratif assignment submission is not shown, so students can\'t see who marked their work.

Note that this setting has no effect on the comments box on the grading page.';
$string['hideshow'] = 'Hide/Show';
$string['hiddenuser'] = 'Participant ';
$string['inactiveoverridehelp'] = '* This override is inactive because the user\'s access to the activity is restricted. This can be due to group or role Collaboratif assignments, other access restrictions, or the activity being hidden.';
$string['indicator:cognitivedepth'] = 'Collaboratif assignment cognitive';
$string['indicator:cognitivedepth_help'] = 'This indicator is based on the cognitive depth reached by the student in an Collaboratif assignment activity.';
$string['indicator:cognitivedepthdef'] = 'Collaboratif assignment cognitive';
$string['indicator:cognitivedepthdef_help'] = 'The participant has reached this percentage of the cognitive engagement offered by the Collaboratif assignment activities during this analysis interval (Levels = No view, View, Submit, View feedback, Comment on feedback, Resubmit after viewing feedback)';
$string['indicator:cognitivedepthdef_link'] = 'Learning_analytics_indicators#Cognitive_depth';
$string['indicator:socialbreadth'] = 'Collaboratif assignment social';
$string['indicator:socialbreadth_help'] = 'This indicator is based on the social breadth reached by the student in an Collaboratif assignment activity.';
$string['indicator:socialbreadthdef'] = 'Collaboratif assignment social';
$string['indicator:socialbreadthdef_help'] = 'The participant has reached this percentage of the social engagement offered by the Collaboratif assignment activities during this analysis interval (Levels = No participation, Participant alone, Participant with others)';
$string['indicator:socialbreadthdef_link'] = 'Learning_analytics_indicators#Social_breadth';
$string['instructionfiles'] = 'Instruction files';
$string['introattachments'] = 'Additional files';
$string['introattachments_help'] = 'Additional files for use in the Collaboratif assignment, such as answer templates, may be added. Download links for the files will then be displayed on the Collaboratif assignment page under the description.';
...
$string['manageCollaboratif assignmentfeedbackplugins'] = 'Manage Collaboratif assignment feedback plugins';
$string['manageCollaboratif assignmentsubmissionplugins'] = 'Manage Collaboratif assignment submission plugins';
...
$string['maxgrade'] = 'Maximum Grade';
$string['maxperpage'] = 'Maximum Collaboratif assignments per page';
$string['maxperpage_help'] = 'The maximum number of Collaboratif assignments a grader can show in the Collaboratif assignment grading page. This setting is useful in preventing timeouts for courses with a large number of participants.';
$string['messageprovider:Collaboratif assignment_notification'] = 'Collaboratif assignment notifications';
$string['modulename'] = 'Collaboratif assignment';
$string['modulename_help'] = 'The Collaboratif assignment activity module enables a teacher to communicate tasks, collect work and provide grades and feedback.

Students can submit any digital content (files), such as word-processed documents, spreadsheets, images, or audio and video clips. Alternatively, or in addition, the Collaboratif assignment may require students to type text directly into the text editor. An Collaboratif assignment can also be used to remind students of \'real-world\' Collaboratif assignments they need to complete offline, such as art work, and thus not require any digital content. Students can submit work individually or as a member of a group.

When reviewing Collaboratif assignments, teachers can leave feedback comments and upload files, such as marked-up student submissions, documents with comments or spoken audio feedback. Collaboratif assignments can be graded using a numerical or custom scale or an advanced grading method such as a rubric. Final grades are recorded in the gradebook.';
$string['modulename_link'] = 'mod/Collaboratif assignment/index';
$string['modulenameplural'] = 'Collaboratif assignments';
$string['moreusers'] = '{$a} more...';
$string['multipleteams'] = 'Member of more than one group';
$string['multipleteams_desc'] = 'The Collaboratif assignment requires submission in groups. You are a member of more than one group. To be able to submit you must be a member of only one group. Please contact your teacher to change your group membership.';
$string['multipleteamsgrader'] = 'Member of more than one group, so unable to make submissions.';
$string['nextuser'] = "Next user";
$string['newsubmissions'] = 'Collaboratif assignments submitted';
...
$string['none'] = 'None';
$string['noonlinesubmissions'] = 'This Collaboratif assignment does not require you to submit anything online';
$string['noopen'] = 'No open date';
$string['nooverridedata'] = 'You must override at least one of the Collaboratif assignment settings.';
$string['nosavebutnext'] = 'Next';
$string['nosubmission'] = 'Nothing has been submitted for this Collaboratif assignment';
$string['noteam'] = 'Not a member of any group';
$string['noteam_desc'] = 'This Collaboratif assignment requires submission in groups. You are not a member of any group, so you cannot create a submission. Please contact your teacher to be added to a group.';
...
$string['number_students'] = 'Number of students per group';
$string['number_students_help'] = 'Precise the number of students per group';
$string['numberofdraftsubmissions'] = 'Drafts';
$string['numberofparticipants'] = 'Participants';
$string['numberofsubmittedCollaboratif assignments'] = 'Submitted';
...
$string['overdue'] = 'Collaboratif assignment is overdue by: {$a}';
...
$string['overridegroupeventname'] = '{$a->Collaboratif assignment} - {$a->group}';
$string['overrides'] = 'Overrides';
$string['overrideuser'] = 'Override user';
$string['overrideusereventname'] = '{$a->Collaboratif assignment} - Override';
$string['outlinegrade'] = 'Grade: {$a}';
$string['page-mod-Collaboratif assignment-x'] = 'Any Collaboratif assignment module page';
$string['page-mod-Collaboratif assignment-view'] = 'Collaboratif assignment module main and submission page';
$string['paramtimeremaining'] = '{$a} remaining';
$string['participant'] = 'Participant';
$string['pluginadministration'] = 'Collaboratif assignment administration';
$string['pluginname'] = 'Collaboratif assignment';
...
$string['preventsubmissions'] = 'Prevent the user from making any more submissions to this Collaboratif assignment.';
...
$string['privacy:metadata:Collaboratif assignmentdownloadasfolders'] = 'A user preference for whether multiple file submissions should be downloaded into folders';
$string['privacy:metadata:Collaboratif assignmentfeedbackpluginsummary'] = 'Feedback data for the Collaboratif assignment.';
$string['privacy:metadata:Collaboratif assignmentfilter'] = 'Filter options such as \'Submitted\', \'Not submitted\', \'Requires grading\', and \'Granted extension\'';
$string['privacy:metadata:Collaboratif assignmentgrades'] = 'Stores user grades for the Collaboratif assignment';
$string['privacy:metadata:Collaboratif assignmentmarkerfilter'] = 'Filter the Collaboratif assignment summary by the Collaboratif assignmented marker.';
$string['privacy:metadata:Collaboratif assignmentid'] = 'Collaboratif assignment ID';
$string['privacy:metadata:Collaboratif assignmentmessageexplanation'] = 'Messages are sent to students through the messaging system.';
$string['privacy:metadata:Collaboratif assignmentoverrides'] = 'Stores override information for the Collaboratif assignment';
$string['privacy:metadata:Collaboratif assignmentperpage'] = 'Number of Collaboratif assignments shown per page.';
$string['privacy:metadata:Collaboratif assignmentquickgrading'] = 'A preference as to whether quick grading is used or not.';
$string['privacy:metadata:Collaboratif assignmentsubmissiondetail'] = 'Stores user submission information';
$string['privacy:metadata:Collaboratif assignmentsubmissionpluginsummary'] = 'Submission data for the Collaboratif assignment.';
$string['privacy:metadata:Collaboratif assignmentuserflags'] = 'Stores user meta data such as extension dates';
$string['privacy:metadata:Collaboratif assignmentusermapping'] = 'The mapping for anonymous submissions';
$string['privacy:metadata:Collaboratif assignmentworkflowfilter'] = 'Filter by the different workflow stages.';
$string['privacy:metadata:grade'] = 'The numerical grade for this Collaboratif assignment submission. Can be determined by scales/advancedgradingforms etc but will always be converted back to a floating point number.';
...
$string['quickgrading_help'] = 'Quick grading allows you to Collaboratif assignment grades (and outcomes) directly in the submissions table. Quick grading is not compatible with advanced grading and is not recommended when there are multiple markers.';
...
$string['requiresubmissionstatement_help'] = 'Require that students accept the submission statement for all submissions to this Collaboratif assignment.';
$string['requireallteammemberssubmit'] = 'Require all group members submit';
$string['requireallteammemberssubmit_help'] = 'If enabled, all members of the student group must click the submit button for this Collaboratif assignment before the group submission will be considered as submitted. If disabled, the group submission will be considered as submitted as soon as any member of the student group clicks the submit button.';
...
$string['revealidentitiesconfirm'] = 'Are you sure you want to reveal student identities for this Collaboratif assignment? This operation cannot be undone. Once the student identities have been revealed, the marks will be released to the gradebook.';
$string['reverttodefaults'] = 'Revert to Collaboratif assignment defaults';
...
$string['Scale'] = 'Scale';
$string['Scale_help'] = 'Collaboratif assignment scale is used to inform students about the total mark of each part of the collaboratif assignment';
$string['search:activity'] = 'Collaboratif assignment - activity information';
...
$string['sendstudentnotifications_help'] = 'Tick this box to send a notification about the updated grade or feedback. If the Collaboratif assignment uses a marking workflow, or the grades are hidden in the grader report, then the notification will not be sent until the grade is released.';
$string['sendnotifications'] = 'Notify graders about submissions';
$string['sendnotifications_help'] = 'If enabled, graders (usually teachers) receive a message whenever a student submits an Collaboratif assignment, early, on time and late. Message methods are configurable.';
$string['selectlink'] = 'Select...';
$string['selectuser'] = 'Select {$a}';
$string['sendlatenotifications'] = 'Notify graders about late submissions';
$string['sendlatenotifications_help'] = 'If enabled, graders (usually teachers) receive a message whenever a student submits an Collaboratif assignment late. Message methods are configurable.';
$string['sendsubmissionreceipts'] = 'Send submission receipt to students';
$string['sendsubmissionreceipts_help'] = 'This switch enables submission receipts for students. Students will receive a notification every time they successfully submit an Collaboratif assignment.';
...
$string['settings'] = 'Collaboratif assignment settings';
...
You can see the status of your Collaboratif assignment submission:

    {$a->url}';
$string['submissioncopiedhtml'] = '<p>You have made a copy of your previous
Collaboratif assignment submission for \'<i>{$a->Collaboratif assignment}</i>\'.</p>
<p>You can see the status of your <a href="{$a->url}">Collaboratif assignment submission</a>.</p>';
$string['submissioncopiedsmall'] = 'You have copied your previous Collaboratif assignment submission for {$a->Collaboratif assignment}';
...
$string['submissionnotready'] = 'This Collaboratif assignment is not ready to submit:';
...
$string['submissionreceiptothertext'] = 'Your Collaboratif assignment submission for
\'{$a->Collaboratif assignment}\' has been submitted.

You can see the status of your Collaboratif assignment submission:

    {$a->url}';
$string['submissionreceiptotherhtml'] = 'Your Collaboratif assignment submission for
\'<i>{$a->Collaboratif assignment}</i>\' has been submitted.<br /><br />
You can see the status of your <a href="{$a->url}">Collaboratif assignment submission</a>.';
$string['submissionreceiptothersmall'] = 'Your Collaboratif assignment submission for {$a->Collaboratif assignment} has been submitted.';
...
You can see the status of your Collaboratif assignment submission:
    ...
    {$a->url}';
$string['submissionreceipthtml'] = '<p>You have submitted an Collaboratif assignment submission for \'<i>{$a->Collaboratif assignment}</i>\'.</p>
<p>You can see the status of your <a href="{$a->url}">Collaboratif assignment submission</a>.</p>';
$string['submissionreceiptsmall'] = 'You have submitted your Collaboratif assignment submission for {$a->Collaboratif assignment}';
$string['submissionslocked'] = 'This Collaboratif assignment is not accepting submissions';
...
$string['submissionstatement_help'] = 'Collaboratif assignment submission confirmation statement';
...
$string['submitCollaboratif assignment_help'] = 'Once this Collaboratif assignment is submitted you will not be able to make any more changes.';
$string['submitCollaboratif assignment'] = 'Submit Collaboratif assignment';
$string['submittedearly'] = 'Collaboratif assignment was submitted {$a} early';
$string['submittedlate'] = 'Collaboratif assignment was submitted {$a} late';
$string['submittedlateshort'] = '{$a} late';
$string['submitted'] = 'Submitted';
$string['subpagetitle'] = '{$a->contextname} - {$a->subpage}';
$string['subplugintype_Collaboratif assignmentsubmission'] = 'Submission plugin';
$string['subplugintype_Collaboratif assignmentsubmission_plural'] = 'Submission plugins';
$string['subplugintype_Collaboratif assignmentfeedback'] = 'Feedback plugin';
$string['subplugintype_Collaboratif assignmentfeedback_plural'] = 'Feedback plugins';
...
$string['teamsubmissiongroupingid_help'] = 'This is the grouping that the Collaboratif assignment will use to find groups for student groups. If not set, the default set of groups will be used.';
$string['textinstructions'] = 'Collaboratif assignment instructions';
...
$string['userCollaboratif assignmentdefaults'] = 'User Collaboratif assignment defaults';
...
$string['usersnone'] = 'No students have access to this Collaboratif assignment.';
...
$string['viewownsubmissionform'] = 'View own submit Collaboratif assignment page.';
...
$string['allowsubmissionsfromdatesummary'] = 'This Collaboratif assignment will accept submissions from <strong>{$a}</strong>';
$string['allowsubmissionsanddescriptionfromdatesummary'] = 'The Collaboratif assignment details and submission form will be available from <strong>{$a}</strong>';
