...
| **🗄️ MySQL** | Stockage des données du plugin |
...
- 🖥️ via l'interface Moodle (Administration → Plugins → Installer un plugin)
...
- ✨ Automatisation complète de la gestion des groupes
- 🎯 Gestion simplifiée pour les enseignants
- 🤝 Collaboration facilitée entre étudiants
...
- 🔗 **LinkedIn**: [Mohamed Saad Bazourhi](https://www.linkedin.com/in/mohamed-saad-bazourhi-3b8445235/)
